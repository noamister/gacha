...
def gacha(money):
    ...
    while change > 0:
        ...
        c = conn.cursor()
        c.execute("select * from items where price <= ?",(change,))
        conn.commit()
    ...
    bill10000 = int(change / 10000)
    change = change % 10000
    bill5000 = int(change / 5000)
    change = change % 50000
    ...
    coin500 = int(change / 500)
    change = change % 5000
    coin100 = int(change / 100)
    change = change % 100
    coin50 = int(change / 50)
    change = change % 50
    coin10 = int(change / 10)
    change = change % 10
    coin5 = int(change / 5)
    coin1 = change % 5
...
def calc():
    cMoney = request.form.get("cMoney")

    if cMoney is None:
        return render_template('calc.html')
    else:

    #r = request.get_data("../app.py", data=payload)
    
    #post money
    #post total
   
    #calcForm内のinputから値を持ってくる
    #    cMoney = request.form.get("c-Money")
        #cMoney = int(cMoney)
        cTotal = request.form.get("cTotal")
        #cTotal = int(cTotal)
        change = int(cMoney) - int(cTotal)
   ...
   #     print(change)
        ...
        return render_template('calc.html', cMoney = cMoney, cTotal = cTotal, change = change, bill10000 = bill10000, bill5000 = bill5000, bill1000 = bill1000, coin500= coin500, coin100= coin100, coin50 = coin50, coin10 = coin10, coin5 = coin5, coin1 = coin1)
